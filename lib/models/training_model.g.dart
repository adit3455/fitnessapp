...
const TrainingModelSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'lExercises': LinkSchema(
      id: -5806263021468562258,
      name: r'lExercises',
...
extension TrainingModelQueryWhereSort
  ...
  QueryBuilder<TrainingModel, TrainingModel, QAfterWhere> anyId() {
...
extension TrainingModelQueryWhere
  ...
  QueryBuilder<TrainingModel, TrainingModel, QAfterWhereClause> idEqualTo(
      Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TrainingModel, TrainingModel, QAfterWhereClause> idNotEqualTo(
      Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TrainingModel, TrainingModel, QAfterWhereClause> idGreaterThan(
      Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TrainingModel, TrainingModel, QAfterWhereClause> idLessThan(
      Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<TrainingModel, TrainingModel, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
...
extension TrainingModelQueryFilter
  ...
  QueryBuilder<TrainingModel, TrainingModel, QAfterFilterCondition> idEqualTo(
      Id value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
  ...
  QueryBuilder<TrainingModel, TrainingModel, QAfterFilterCondition> idLessThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TrainingModel, TrainingModel, QAfterFilterCondition> idBetween(
    Id lower,
    Id upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TrainingModelQueryLinks
    on QueryBuilder<TrainingModel, TrainingModel, QFilterCondition> {
  QueryBuilder<TrainingModel, TrainingModel, QAfterFilterCondition> lExercises(
      FilterQuery<ExerciseModel> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'lExercises');
    });
  }

  QueryBuilder<TrainingModel, TrainingModel, QAfterFilterCondition>
      lExercisesLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'lExercises', length, true, length, true);
    });
  }
  ...
  QueryBuilder<TrainingModel, TrainingModel, QAfterFilterCondition>
      lExercisesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'lExercises', 0, true, 0, true);
    });
  }

  QueryBuilder<TrainingModel, TrainingModel, QAfterFilterCondition>
      lExercisesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'lExercises', 0, false, 999999, true);
    });
  }

  QueryBuilder<TrainingModel, TrainingModel, QAfterFilterCondition>
      lExercisesLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'lExercises', 0, true, length, include);
    });
  }

  QueryBuilder<TrainingModel, TrainingModel, QAfterFilterCondition>
      lExercisesLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'lExercises', length, include, 999999, true);
    });
  }

  QueryBuilder<TrainingModel, TrainingModel, QAfterFilterCondition>
      lExercisesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'lExercises', lower, includeLower, upper, includeUpper);
    });
  }
}
...
extension TrainingModelQuerySortBy
  ...
  QueryBuilder<TrainingModel, TrainingModel, QAfterSortBy> sortByHashCode() {
    return QueryBuilder.apply(this, (query) {
...
extension TrainingModelQuerySortThenBy
  ...
  QueryBuilder<TrainingModel, TrainingModel, QAfterSortBy> thenByHashCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.asc);
    });
  }
  ...
  QueryBuilder<TrainingModel, TrainingModel, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.asc);
    });
  }

  QueryBuilder<TrainingModel, TrainingModel, QAfterSortBy> thenByIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TrainingModelQueryWhereDistinct
  ...
  QueryBuilder<TrainingModel, TrainingModel, QDistinct> distinctByHashCode() {
    return QueryBuilder.apply(this, (query) {
...
extension TrainingModelQueryProperty
  ...
  QueryBuilder<TrainingModel, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<TrainingModel, int, QQueryOperations> hashCodeProperty() {
    return QueryBuilder.apply(this, (query) {
